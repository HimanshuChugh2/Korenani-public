...
<body>
 ...
 <!-- NAV WITH BLUE COLOR -->
   <head th:replace="fragments/header :: navForLandingPage">
								...
								<div class="d-sm-flex justify-content-between">
									<div data-aos="zoom-in-up">
										<div class="banner-title">
												<h1 class="font-weight-medium">We are here to Help Teachers Earn and Students Learn.
											</h1>
										</div>
										<h5 class="mt-3">Korenani is a platform to learn Foreign Languages of your choice. 

											<br>
											<br>
										Enroll in courses created by professional teachers from around the world and start learning today.
										</h5>
